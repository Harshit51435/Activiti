...
public class Activiti5Util {
    ...
    public static boolean isActiviti5ProcessDefinitionId(CommandContext commandContext,
    ...
    /**
     * Use this method when running outside a {@link CommandContext}. It will check
     * the cache first and only start a new {@link CommandContext} when no result is
     * found in the cache.
     */
    public static boolean isActiviti5ProcessDefinitionId(
            final ProcessEngineConfigurationImpl processEngineConfiguration, final String processDefinitionId) {
    ...
    public static boolean isActiviti5ProcessDefinition(CommandContext commandContext,
        ...
        if (processDefinition.getEngineVersion() != null) {
            if (Activiti5CompatibilityHandler.ACTIVITI_5_ENGINE_TAG.equals(processDefinition.getEngineVersion())) {
                ...
                throw new ActivitiException("Invalid 'engine' for process definition " + processDefinition.getId()
    ...
    public static Activiti5CompatibilityHandler getActiviti5CompatibilityHandler() {
        ...
        if (activiti5CompatibilityHandler == null) {
            throw new ActivitiException(
                    "Found Activiti 5 process definition, but no compatibility handler on the classpath");
        }
